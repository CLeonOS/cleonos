...
#define CLEONOS_SYSCALL_NET_TCP_LISTEN 158ULL
#define CLEONOS_SYSCALL_NET_TCP_ACCEPT 159ULL
...
#define CLEONOS_MMAP_FLAG_PRIVATE 0x02ULL
#define CLEONOS_MMAP_FLAG_ANONYMOUS 0x20ULL
