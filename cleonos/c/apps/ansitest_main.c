...
static int ush_cmd_ansitest(void) {
    ...
    ush_writeln_i18n("\x1B[1;96mANSI test suite\x1B[0m", "\x1B[1;96mANSI 测试套件\x1B[0m");
    ush_writeln_i18n("styles: \x1B[1mbold\x1B[0m  \x1B[7minverse\x1B[0m  \x1B[4munderline\x1B[0m",
                     "样式: \x1B[1m粗体\x1B[0m  \x1B[7m反色\x1B[0m  \x1B[4m下划线\x1B[0m");
    ush_writeln_i18n("16-color demo:", "16 色演示:");
    (void)ush_cmd_ansi();

    ush_writeln_i18n("256-color palette (0..255):", "256 色调色板:");
    ...
    ush_writeln_i18n("truecolor demo:", "真彩色演示:");
    ...
    ush_writeln_i18n("cursor control demo:", "光标控制演示:");
    ...
    ush_writeln_i18n("erase-line demo:", "擦除行演示:");
